                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <ul class="nav lmhorizontal mb-4" style="grid-template-columns: repeat(2, 1fr);">
                                <a href="{{url('lottogame/ordenes')}}?cat=urgente">
                                    <li class="nav-item @if($cat == 'urgente') active @endif">Urgente</li>
                                </a>
                                <a href="{{url('lottogame/ordenes')}}?cat=seguimiento">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-asignarOrden" method="POST" autocomplate="off" action="{{url('lottogame/problemas/orden/asignar')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-6">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <label>Observación de encargado de lottogame</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a onclick="finalizar()" class="btn btn-primary float-right text-white" id="bfinalizar">Finalizar</a>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function cargar(cat) {
            ...
            $.ajax({
                url: "{{url('lottogame/ordenes/cargar')}}",
                method: "post",
                dataType: 'text',
                data: {
                    '_token': "{{csrf_token()}}",
...
$('[name="ot_cgarantia"]').change(function () {
    ...
    function modalAsignarOrdenDeTrabajo(id, visualId, entidad) {
        $.ajax({
            url: "{{url('lottogame/problemas/orden')}}",
            method: "post",
            data: {
                '_token': "{{csrf_token()}}",
                'id': id
            ...
            $.ajax({
                url: "{{url('lottogame/problemas/imagenes')}}",
                method: "post",
                data: {
                    '_token': "{{csrf_token()}}",
                    'id': id
            ...
            if (done.enproceso != null) {
                ...
                $.ajax({
                    url: "{{url('lottogame/problemas/trabajo/ver')}}",
                    method: "post",
                    data: {
                        '_token': "{{csrf_token()}}",
                        'id': otrabajo,
                ...
                $('[name="ot_estado"][value='+done.estado+']').prop('checked', true);
    ...
    function finalizar() {
        $.ajax({
            url: "{{url('lottogame/problemas/finalizar')}}",
            method: "post",
            data: {
                '_token': "{{csrf_token()}}",
