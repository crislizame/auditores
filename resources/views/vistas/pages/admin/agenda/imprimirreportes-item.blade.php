                ...
                <div class="card-body pl-0 pr-0 pb-0 pt-0">
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr class="row">
                            @php
                            $images = Illuminate\Support\Facades\DB::select(DB::raw("SELECT id FROM attachments INNER JOIN encauditdata_attachments ON attachments.idattachments = encauditdata_attachments.attachments_id WHERE encauditdata_attachments.encauditdatas_id = ".$id." LIMIT 4"));
                            @endphp
