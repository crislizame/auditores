                ...
                <div class="col-lg-12 mt-3">
                    <div class="card m-0">
                        <div class="card-body pl-0 pr-0 pb-0 pt-0">
                            <h6 class="titulos-grandes p-2 text-white"><a class="text-white" target="_blank" href="{{route('imprimir/reportes-item')}}?cat=auditoria&id={{request('id')}}"> <i class="fa fa-print text-white"></i>Ver en Formato de Impresión</a></h6>
                            ...
                            <h4 class="titulos-grandes p-2">Estado</h4>
                            @php
                                ...
                                <table class="table ">
                                    ...
                                    @forelse($thc as $th)
                                        <tr>
                                            ...
                                            <td width="10%"><img src="{{asset('img/cara'.(new \App\Encauditdata())->where(['encauditvalues_id'=>$th->idencauditvalues,'agenda_id'=>$datos->agenda_id,'pds_id'=>$pdsdata->id])->value('carita').'2.jpg')}}" width="50px" alt="carita"></td>
                                            <td width="40%"><b>{{ucfirst((new \App\Encauditdata())->where(['encauditvalues_id'=>$th->idencauditvalues,'agenda_id'=>$datos->agenda_id,'pds_id'=>$pdsdata->id])->value('observa'))}}</b></td>
{{--                                            <td><button data-id="{{(new \App\Encauditdata())->where(['encauditvalues_id'=>$th->idencauditvalues,'agenda_id'=>$datos->agenda_id,'pds_id'=>$pdsdata->id])->value('idencauditdatas')}}" class="btn btn-sm btn-primary btn-verfotos">Ver Fotos</button></td>--}}
                                        </tr>
                                    @empty
                                    @endforelse
                                    </tbody>
                            ...
                            @empty
                            @endforelse
                            <h4 class="titulos-grandes p-2">Activo</h4>
                            @php
