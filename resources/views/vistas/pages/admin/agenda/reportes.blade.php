                ...
                <div class="card-body pb-3 pt-3">
                    ...
                    <table class="table table-bordered tabla-reportes ">
                        ...
                        <tbody>
                            ...
                            break;
                            case "estados":
                            $auditreport = (new \App\Auditoria_reporte())->where('tipo','A')->orderBy('idauditoria_reportes','desc')->get();
                            break;
                            case "procesos":
                            ...
                            <tr>
                                <td><a href="{{route("agenda/reportes-item")}}?cat={{($aure->tipo=='N'?'A':$aure->tipo)}}&id={{$aure->idauditoria_reportes}}">#{{($aure->tipo=='N'?'A':$aure->tipo).'-'.str_pad($aure->idauditoria_reportes, 7, "0", STR_PAD_LEFT)}}</a></td>
