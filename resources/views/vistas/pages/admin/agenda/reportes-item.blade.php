...
<div class="container-fluid ">
    ...
    <div class="row mt-1">
        <div class="col-12">
            <ul class="nav lmhorizontal4">
                <li onclick="window.location.href = '{{route('agenda/reportes-item')}}?cat=auditoria&id={{request('id')}}'" class="nav-item @if(request('cat') == " auditoria") active @endif"><a href="{{route('agenda/reportes-item')}}?cat=auditoria&id={{request('id')}}" class="">Reporte Auditor</a></li>
                <li onclick="window.location.href = '{{route('agenda/reportes-item')}}?cat=procesos&id={{request('id')}}'" class="nav-item @if(request('cat') == " procesos") active @endif"><a href="{{route('agenda/reportes-item')}}?cat=procesos&id={{request('id')}}">Reporte Procesos</a></li>
            </ul>
        </div>
    </div>
    @php
