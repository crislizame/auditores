...
class LottoGameController extends Controller
{
    ...
    public function perfil()
    {
        ...
        return view('vistas.pages.lottogame.perfil')->with('user', $user)->with('calificacion', $calificacion)->with('cumple', $cumple);
    }
    ...
    public function cambiarFotoPerfil(Request $request){
        ...
        return Redirect::to('lottogame/perfil');
    }
    ...
    public function calificar(Request $request)
    {
        ...
        return redirect('lottogame/ordenes')->with('cat', 'urgente');
    }
}
