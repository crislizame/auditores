...
class SoporteController extends Controller
{
    ...
    public function ordenes(Request $request)
    {
        $cat = (isset($request->cat) ? $request->cat : 'loteria');
        $proveedores = DB::table('proveedores')->orderBy('idproveedores', 'asc')->get();
        return view('vistas.pages.soporte.ordenes')->with('cat', $cat)->with('proveedores', $proveedores);
    }
    ...
    public function perfil()
    {
        ...
        return view('vistas.pages.soporte.perfil')->with('user', $user)->with('calificacion', $calificacion)->with('cumple', $cumple);
    }
